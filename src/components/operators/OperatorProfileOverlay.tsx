...
const OperatorProfileOverlay: React.FC<OperatorProfileOverlayProps> = ({
  ...
  const profileImages: { label: string; src?: string }[] = [
    ...
    { label: "Figura intera", src: operator.fullBodyPhotoFile },
    { label: "Mezzo busto", src: operator.bustPhotoFile },
            ...
            {operator.driversLicense && (
              <>
                ...
                <div>
                  ...
                  <div className="font-medium">
                    {typeof operator.hasVehicle === "boolean"
                      ? operator.hasVehicle ? "Sì" : "No"
                      : "-"}
                  </div>
                </div>
              </>
          ...
          {operator.contractPdfName && operator.contractPdf && (
            <div>
              <a
                ...
                download={operator.contractPdfName}
              >
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-full max-w-5xl p-0 rounded-lg overflow-hidden shadow-2xl">
        <DialogHeader>
          <DialogTitle>Profilo Operatore</DialogTitle>
          <DialogDescription>
            Dettagli sui dati personali e contrattuali dell'operatore.
          </DialogDescription>
        </DialogHeader>
